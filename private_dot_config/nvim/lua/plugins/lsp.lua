        ...
        config = function(_, opts)
            vim.api.nvim_create_autocmd("LspAttach", {
                ...
                callback = function(event)
                    ...
                    map("gra", FzfLua.lsp_code_actions, "Code Action", { "n", "x" })

                    map('<leader>n', vim.lsp.buf.rename, 'Re[n]ame')
                    map("<leader>o", FzfLua.lsp_document_symbols, "Symb[o]ls")
                    -- Diagnostics
                    map("<leader>q", FzfLua.lsp_document_diagnostics, "Diagnosti[q]s [L]ist")
                    map("<leader><leader>q", FzfLua.lsp_workspace_diagnostics, "Diagnosti[q]s [W]orkspace")
